...
describe("heartbeat-reason", () => {
  ...
  it.each([
    ...
    { value: "telegram-reaction", expected: "wake" },
    { value: "telegram-reaction:dm", expected: "wake" },
  ...
  it.each([
    ...
    { value: "telegram-reaction", expected: true },
  ...
  it.each([
    ...
    { value: "telegram-reaction", expected: true },
    { value: "telegram-reaction:dm", expected: true },
    { value: "interval", expected: false },
